...
const RequestForm = () => {
	return (
		...
		// 			<div className="-px-3 w-full pb-5 text-center text-primary">
		...
		<div
			className="relative mx-auto flex h-full items-center justify-center border bg-solitude bg-[url('/images/Group.png')] bg-contain bg-center bg-no-repeat object-contain md:h-[820px]"
			style={{ backgroundImage: `url('images/Group.png')` }}
		>
