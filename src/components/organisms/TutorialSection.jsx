	...
	return (
		<>
			<div className="container">
				<div>
					<div
						className="[85px] ml-4 rounded-tl-3xl bg-primary bg-[93%] bg-no-repeat p-4 pl-4 md:ml-24 md:h-80 md:rounded-l-3xl md:bg-tutorialMagniLaptopBg md:p-8 md:pl-16"
							...
							<div>
								...
								{leaderboard.map((val, key) => (
									<div className="flex gap-1 py-3 text-sm text-secondary" key={key}>
										...
										<div className="ml-3 w-[30%] bg-secondary text-center text-white">
											{val.views}
										</div>
									</div>
								))}
