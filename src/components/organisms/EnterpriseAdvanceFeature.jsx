...
const EnterpriseAdvanceFeature = () => {
	return (
		<div className="relative h-full w-full md:-mt-10 md:px-20">
			<div className="md:w-2/3">
				...
				<div className="textt-base w-full pt-5 font-extralight text-white md:pt-10 md:text-2xl md:font-light md:text-secondary">
					<p>
