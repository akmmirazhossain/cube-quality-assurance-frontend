	...
	return (
		<div className="bg-solitude">
			<div className="container w-full">
				<div
					className={`${
						isRTL() ? 'rtl-bulb-bg-position' : 'bulb-bg-position'
					} bulb-bg-size max-h-[350px] w-[80%] ${
						isRTL() ? 'rounded-bl-35 rounded-tl-35' : 'rounded-br-35 rounded-tr-35'
					} bg-primary bg-searchBulb bg-no-repeat px-[10%] py-[5%] md:bg-auto`}
				>
