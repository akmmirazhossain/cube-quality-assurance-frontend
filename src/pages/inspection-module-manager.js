...
const InspectionModuleManager = () => {
	return (
		<div>
			<div className="relative h-screen w-full bg-[url('/images/shapes/HalfRound.png')] bg-auto bg-left-bottom bg-no-repeat">
				<div className="relative h-full p-10 sm:p-16 md:p-24">
					<div className=" h-full w-full bg-inherit bg-right bg-no-repeat md:bg-inspectionModule">
...
export default InspectionModuleManager;
